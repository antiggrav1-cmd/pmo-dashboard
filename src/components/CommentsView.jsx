...
/**
 * Styling mappings for Restriction Categories matching the user screenshot exactly:
 * - Suministro: Light red/pink
 * - Diseño: Light orange/peach
 * - Logística: Yellow/amber
 * - Calidad: Light green
 * - OR/CREG: Sky blue
 * - Contratista: Teal/Cyan
 * - SST: Light purple/lavender
 * - Financiera: Dark purple
 * - Montaje: Dark emerald/green
 * - DD: Light grey/slate
 */
